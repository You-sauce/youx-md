...
const spiderHandler = require('./youx');
    ...
    sock.ev.on('connection.update', async (update) => {
		...
		image: fs.readFileSync(imagePath),
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        title: "ʏᴏᴜx ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ",
                        body: "ʙᴏᴛ ʙʏ ʏᴏᴜ ᴛᴇᴄʜ",
...
╰┄┄┄┄┄┄┄┄┄┄┄┄┄┈┄┄┄⪼`.trim();
        ...
        console.error("[youx Error] Group Update Logic:", e);
    }
});
...
if (config && config.autotyping === 'on' && !m.key.fromMe) {
    ...
    if (isGroup && fs.existsSync(antilinkPath)) {
        try {
            ...
            console.log("[youx Error] Antilink Logic:", err);
        }
    }
